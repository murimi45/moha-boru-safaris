...
<header class="mb-navbar" role="banner">
    <div class="container-mb d-flex align-items-center justify-content-between">

        <a href="{{ url('/') }}" class="brand-mark">Moha <span>Boru</span></a>

        <nav class="d-none d-lg-flex align-items-center" aria-label="Primary">
        ...
        <div class="d-flex align-items-center gap-3">
            <a href="{{ url('/booking') }}" class="btn-mb btn-mb-gold d-none d-md-inline-flex">
                Plan Your Safari <i class="bi bi-arrow-right"></i>
            </a>
            <button class="nav-toggle d-lg-none" aria-label="Open menu" aria-expanded="false" aria-controls="mb-mobile-menu">
